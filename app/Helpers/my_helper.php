...
function curl($type, $category, $page = 1)
{
  $api_key = 'bd3b77b0db915a809f11ad2bd7469481';

  $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, "http://api.themoviedb.org/3/$type/$category?api_key=$api_key&language=id-ID&page=$page");
...
function getMovies()
{
  ...
  $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, "https://api.themoviedb.org/3/discover/movie?api_key=$api_key&language=id-ID");
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
  curl_setopt($ch, CURLOPT_HEADER, FALSE);
  curl_setopt($ch, CURLOPT_HTTPHEADER, array("Accept: application/json"));
  $response = curl_exec($ch);
...
function getDetailMovie($id)
{
  ...
  $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, "https://api.themoviedb.org/3/movie/$id?api_key=$api_key&language=id-ID");
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
  curl_setopt($ch, CURLOPT_HEADER, FALSE);
  curl_setopt($ch, CURLOPT_HTTPHEADER, array("Accept: application/json"));
  $response = curl_exec($ch);
...
function getTvTrailer($id)
{
  // dd($id);
  $api_key = 'bd3b77b0db915a809f11ad2bd7469481';

  $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, "https://api.themoviedb.org/3/tv/$id/videos?api_key=$api_key");
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
  curl_setopt($ch, CURLOPT_HEADER, FALSE);
  curl_setopt($ch, CURLOPT_HTTPHEADER, array("Accept: application/json"));
  $response = curl_exec($ch);
...
function getSimilarMovie($id)
{
  ...
  $ch = curl_init();
  curl_setopt($ch, CURLOPT_URL, "https://api.themoviedb.org/3/movie/$id/similar?api_key=$api_key&language=id-ID");
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
  curl_setopt($ch, CURLOPT_HEADER, FALSE);
  curl_setopt($ch, CURLOPT_HTTPHEADER, array("Accept: application/json"));
  $response = curl_exec($ch);
